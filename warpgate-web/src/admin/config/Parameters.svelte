        ...
        {#if parameters}
            ...
            <SectionedForm>
                ...
                <Section id="login" title="Login">
                    ...
                    <HelpText>
                        When exactly one SSO provider is configured, unauthenticated browser navigations are redirected straight to the provider instead of showing the login page. Append <code>?login=password</code> to any URL to reach the password login form.
                    </HelpText>
                </Section>
                {/if}
